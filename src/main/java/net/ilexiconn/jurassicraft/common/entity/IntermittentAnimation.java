...
public class IntermittentAnimation {
    ...
    public float getAnimationProgressSin() {
        return Mth.sin(1.57079632679f * (float) (timer / duration));
    }

    public float getAnimationProgressSinSqrt() {
        float result = Mth.sin(1.57079632679f * (float) (timer / duration));
        return result * result;
    }

    public float getAnimationProgressSinToTen() {
        return (float) Math.pow((double) Mth.sin(1.57079632679f * (float) (timer / duration)), 10);
    }

    public float getAnimationProgressSinPowerOf(int i) {
        return (float) Math.pow((double) Mth.sin(1.57079632679f * (float) (timer / duration)), i);
    }
