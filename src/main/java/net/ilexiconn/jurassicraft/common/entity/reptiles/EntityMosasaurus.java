...
public class EntityMosasaurus extends EntityJurassiCraftSwimmingBase {
    public ChainBuffer tailBuffer = new ChainBuffer(12);

    public EntityMosasaurus(EntityType<? extends EntityMosasaurus> type, Level world) {
        super(type, world);
    }

    public EntityMosasaurus(Level world) {
        super(world);
    }
    ...
    public LivingEntity getTargetPriority(LivingEntity target, LivingEntity entity) {
        if (target != null) {
            if (target instanceof Player)
                return target;
            else if (target instanceof EntityMosasaurus) // Won't go for other Mosasaurus unless nothing else around
                return entity;
            else
                return target;
        } else
    ...
    protected void dropCustomDeathLoot(DamageSource damageSource, int lootingLevel, boolean recentlyHit) {
        ...
        if (!this.isOnFire()) {
            ...
            if (meat != null)
                ...
                System.err.println("Meat was null for Mosasaurus!");
        } else {
            ...
            if (steak != null)
                ...
                System.err.println("Steak was null for Mosasaurus!");
        }
        ...
        if (this.getRandom().nextFloat() < 0.1F) {
            ...
            if (skull != null)
                ...
                System.err.println("Skull was null for Mosasaurus!");
        }
        ...
        if (this.isMale() && this.getRandom().nextFloat() < 0.25F) {
            ...
            if (skin != null)
                ...
                System.err.println("Skin was null for Mosasaurus!");
        }
    }
}
