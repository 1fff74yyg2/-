...
public class JurassiCraftAIDefensiveReaction extends Goal {
    ...
    public boolean canContinueToUse() {
        return this.attacker.isAlive() && this.creature.isDefending() && this.distanceSqFromAttacker < this.maximumSquaredDistance && (this.resetStateWhenTriggered ? this.creature.getTarget() == null : true) && !this.creature.isSitting() && this.creature.getPassengers().isEmpty();
    }
