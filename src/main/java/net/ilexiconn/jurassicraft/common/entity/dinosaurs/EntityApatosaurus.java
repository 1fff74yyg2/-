...
public class EntityApatosaurus extends EntityJurassiCraftProtective implements IHerbivore {

   public ChainBuffer tailBuffer = new ChainBuffer(5);


   public EntityApatosaurus(EntityType<? extends EntityApatosaurus> type, Level world) {
      super(type, world);
    }

   public EntityApatosaurus(Level world) {
        super(world);
    }
