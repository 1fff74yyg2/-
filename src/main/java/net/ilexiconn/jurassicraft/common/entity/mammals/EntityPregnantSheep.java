...
public class EntityPregnantSheep {
    ...
    private static final Map<UUID, EntityPregnantSheep> PREGNANT_SHEEPS = new HashMap<UUID, EntityPregnantSheep>();
    ...
    public static final void register(Sheep entity) {
        PREGNANT_SHEEPS.put(entity.getUUID(), new EntityPregnantSheep());
    }

    public static final EntityPregnantSheep get(Sheep entity) {
        EntityPregnantSheep pregnant = PREGNANT_SHEEPS.get(entity.getUUID());
        if (pregnant != null) {
     ...
     */
    public void loadFromNbt(Sheep entity) {
        if (this.loadedFromNbt)
            return;
        this.loadedFromNbt = true;
        net.minecraft.nbt.CompoundTag tag = entity.getPersistentData();
        if (tag.contains("SheepPregnantJC")) {
            net.minecraft.nbt.CompoundTag data = tag.getCompound("SheepPregnantJC");
    ...
    public void saveToNbt(Sheep entity) {
        ...
        entity.getPersistentData().put("SheepPregnantJC", data);
    }
}
