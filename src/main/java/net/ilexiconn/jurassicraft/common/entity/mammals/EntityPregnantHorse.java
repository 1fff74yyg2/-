...
public class EntityPregnantHorse {
    ...
    private static final Map<UUID, EntityPregnantHorse> PREGNANT_HORSES = new HashMap<UUID, EntityPregnantHorse>();
    ...
    public static final void register(Horse entity) {
        PREGNANT_HORSES.put(entity.getUUID(), new EntityPregnantHorse());
    }

    public static final EntityPregnantHorse get(Horse entity) {
        EntityPregnantHorse pregnant = PREGNANT_HORSES.get(entity.getUUID());
        if (pregnant != null) {
     ...
     */
    public void loadFromNbt(Horse entity) {
        if (this.loadedFromNbt)
            return;
        this.loadedFromNbt = true;
        net.minecraft.nbt.CompoundTag tag = entity.getPersistentData();
        if (tag.contains("HorsePregnantJC")) {
            net.minecraft.nbt.CompoundTag data = tag.getCompound("HorsePregnantJC");
    ...
    public void saveToNbt(Horse entity) {
        ...
        entity.getPersistentData().put("HorsePregnantJC", data);
    }
}
