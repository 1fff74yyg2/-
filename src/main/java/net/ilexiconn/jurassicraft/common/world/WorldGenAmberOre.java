...
public class WorldGenAmberOre {
    public static final ResourceKey<ConfiguredFeature<?, ?>> CONFIGURED = ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation("jurassicraft", "amber_ore"));
    public static final ResourceKey<PlacedFeature> PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation("jurassicraft", "amber_ore"));

    public static void bootstrapConfigured(BootstapContext<ConfiguredFeature<?, ?>> context) {
        OreConfiguration.TargetBlockState target = OreConfiguration.target(
                new TagMatchTest(BlockTags.STONE_ORE_REPLACEABLES), JCBlockRegistry.amberOre.defaultBlockState());
