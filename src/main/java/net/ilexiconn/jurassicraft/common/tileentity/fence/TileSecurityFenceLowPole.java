...
public class TileSecurityFenceLowPole extends BlockEntity {
    ...
    public TileSecurityFenceLowPole(BlockPos pos, BlockState state) {
        super(JCTileEntityRegistry.FENCE_LOW_POLE.get(), pos, state);
