...
public class ModelEmbryo extends MowzieModelBase {
    ...
    public void render(TileCultivate tile) {
        ...
        shapes[0].rotationPointY -= Mth.cos(tile.animationTick * 0.05f) * 1;
        chainWave(BodyParts, 0.05f, 0.1f, 1, tile.animationTick, 1f);
        shapes[5].rotateAngleX += Mth.cos(tile.animationTick * 0.05f - 5) * 0.2;
        shapes[6].rotateAngleX += Mth.cos(tile.animationTick * 0.05f - 5) * 0.2;
        shapes[7].rotateAngleX += Mth.cos(tile.animationTick * 0.05f - 5) * 0.2;
        shapes[8].rotateAngleX += Mth.cos(tile.animationTick * 0.05f - 5) * 0.2;
        shapes[0].rotateAngleX += -0.1 * Mth.cos(tile.animationTick * 0.05f);
