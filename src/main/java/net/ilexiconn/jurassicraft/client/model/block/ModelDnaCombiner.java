...
public class ModelDnaCombiner extends AdvancedModelBase {
    AdvancedModelRenderer general;
    AdvancedModelRenderer general1;
    AdvancedModelRenderer general2;
    AdvancedModelRenderer pantalla;
    AdvancedModelRenderer tapa;
    AdvancedModelRenderer deco;
    AdvancedModelRenderer cil1;
    AdvancedModelRenderer cil2;
    AdvancedModelRenderer cil3;
    AdvancedModelRenderer cil4;
    AdvancedModelRenderer fras1;
    AdvancedModelRenderer tap1;
    AdvancedModelRenderer tub2;
    AdvancedModelRenderer base;
    AdvancedModelRenderer fras2;
    AdvancedModelRenderer tap2;
    AdvancedModelRenderer tub1;
