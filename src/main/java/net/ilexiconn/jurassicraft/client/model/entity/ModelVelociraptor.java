...
//        Head.rotateAngleX -= 0.3 * f1 * dontLeanProgress;
        ...
        // Idling
        chainWave(tailParts, 0.1F, 0.05F, 2, entity.tickCount, 1F);
        chainWave(bodyParts, 0.1F, -0.03F, 5, entity.tickCount, 1F);
        chainWave(rightArmParts, 0.1F, -0.1F, 4, entity.tickCount, 1F);
        chainWave(leftArmParts, 0.1F, -0.1F, 4, entity.tickCount, 1F);
