...
public class ModelBrachiopod extends AdvancedModelBase {
    AdvancedModelRenderer backBottom;
    AdvancedModelRenderer frontBottom;
    AdvancedModelRenderer shellBottom;
    AdvancedModelRenderer rightBottom;
    AdvancedModelRenderer leftBottom;
    AdvancedModelRenderer leftTop;
    AdvancedModelRenderer shellTop;
    AdvancedModelRenderer frontTop;
    AdvancedModelRenderer pearl;
    AdvancedModelRenderer backTop;
    AdvancedModelRenderer rightTop;

    public ModelBrachiopod() {
        super();
        this.textureWidth = 64;
        this.textureHeight = 32;
        (this.backBottom = new AdvancedModelRenderer(this, 0, 27)).addBox(0.0f, 0.0f, 0.0f, 14, 4, 1);
        ...
        (this.frontBottom = new AdvancedModelRenderer(this, 0, 26)).addBox(0.0f, 0.0f, 0.0f, 14, 5, 1);
        ...
        (this.shellBottom = new AdvancedModelRenderer(this, 0, 0)).addBox(-7.0f, 23.0f, -7.0f, 14, 1, 14);
        ...
        (this.rightBottom = new AdvancedModelRenderer(this, 32, 10)).addBox(0.0f, 0.0f, 0.0f, 1, 4, 14);
        ...
        (this.leftBottom = new AdvancedModelRenderer(this, 32, 10)).addBox(0.0f, 0.0f, 0.0f, 1, 4, 14);
        ...
        (this.leftTop = new AdvancedModelRenderer(this, 32, 10)).addBox(5.0f, -4.0f, -14.0f, 1, 4, 14);
        ...
        (this.shellTop = new AdvancedModelRenderer(this, 0, 0)).addBox(-8.0f, -4.0f, -14.0f, 14, 1, 14);
        ...
        (this.frontTop = new AdvancedModelRenderer(this, 0, 26)).addBox(-8.0f, -4.0f, -14.0f, 14, 5, 1);
        ...
        (this.pearl = new AdvancedModelRenderer(this, 0, 17)).addBox(0.0f, 0.0f, -0.1f, 6, 2, 6);
        ...
        (this.backTop = new AdvancedModelRenderer(this, 0, 26)).addBox(-8.0f, -4.0f, -1.0f, 14, 5, 1);
        ...
        (this.rightTop = new AdvancedModelRenderer(this, 32, 10)).addBox(-8.0f, -4.0f, -14.0f, 1, 4, 14);
    ...
    private void setRotation(final AdvancedModelRenderer model, final float x, final float y, final float z) {
