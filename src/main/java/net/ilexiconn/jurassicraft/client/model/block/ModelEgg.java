...
public class ModelEgg extends AdvancedModelBase {
    public AdvancedModelRenderer[] shapes = new AdvancedModelRenderer[4];

    public ModelEgg() {
        textureWidth = 64;
        textureHeight = 32;

        shapes[0] = new AdvancedModelRenderer(this, 0, 21);
        shapes[0].addBox(-3F, 0F, -3F, 6, 5, 6);
        shapes[0].setRotationPoint(0F, 18F, 0F);

        shapes[1] = new AdvancedModelRenderer(this, 0, 14);
        shapes[1].addBox(-2.5F, 0F, -2.5F, 5, 2, 5);
        shapes[1].setRotationPoint(0F, 22F, 0F);

        shapes[2] = new AdvancedModelRenderer(this, 24, 24);
        shapes[2].addBox(-2.5F, 0F, -2.5F, 5, 3, 5);
        shapes[2].setRotationPoint(0F, 16F, 0F);

        shapes[3] = new AdvancedModelRenderer(this, 24, 18);
