...
public class ModelCompressor extends AdvancedModelBase {
    // fields
    AdvancedModelRenderer compressorBase;
    AdvancedModelRenderer compressorSlab;
    AdvancedModelRenderer buttonBase1;
    AdvancedModelRenderer buttonTop1;
    AdvancedModelRenderer buttonBase2;
    AdvancedModelRenderer buttonTop2;
    AdvancedModelRenderer buttonBase3;
    AdvancedModelRenderer buttonTop3;
    AdvancedModelRenderer compressorTopSlab1;
    AdvancedModelRenderer compressorTobSlab2;
    AdvancedModelRenderer openStuff;

    public ModelCompressor() {
        textureWidth = 128;
        textureHeight = 64;

        compressorBase = new AdvancedModelRenderer(this, 0, 0);
        ...
        compressorSlab = new AdvancedModelRenderer(this, 0, 25);
        ...
        buttonBase1 = new AdvancedModelRenderer(this, 70, 4);
        ...
        buttonTop1 = new AdvancedModelRenderer(this, 70, 0);
        ...
        buttonBase2 = new AdvancedModelRenderer(this, 70, 10);
        ...
        buttonTop2 = new AdvancedModelRenderer(this, 70, 19);
        ...
        buttonBase3 = new AdvancedModelRenderer(this, 70, 10);
        ...
        buttonTop3 = new AdvancedModelRenderer(this, 70, 19);
        ...
        compressorTopSlab1 = new AdvancedModelRenderer(this, 32, 43);
        ...
        compressorTobSlab2 = new AdvancedModelRenderer(this, 0, 45);
        ...
        openStuff = new AdvancedModelRenderer(this, 70, 24);
