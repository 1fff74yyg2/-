...
@OnlyIn(Dist.CLIENT)
public class ModelLiopleurodon extends AdvancedModelBase {
    AdvancedModelRenderer midbody;
    AdvancedModelRenderer neck;
    AdvancedModelRenderer tail;
    AdvancedModelRenderer tailmiddle;
    AdvancedModelRenderer lowerjawback;
    AdvancedModelRenderer tailtip;
    AdvancedModelRenderer upperbody;
    AdvancedModelRenderer lowerbody;
    AdvancedModelRenderer lowerjawfront;
    AdvancedModelRenderer lowerjawmid;
    AdvancedModelRenderer upperjawback;
    AdvancedModelRenderer upperjawmid;
    AdvancedModelRenderer upperjawfront;
    AdvancedModelRenderer upperleftfin;
    AdvancedModelRenderer upperrightfin;
    AdvancedModelRenderer lowerleftfin;
    AdvancedModelRenderer lowerrightfin;
    AdvancedModelRenderer teeth_top;
    AdvancedModelRenderer lowerbodytop;
    AdvancedModelRenderer midbodytop;
    AdvancedModelRenderer upperbodytop;
    AdvancedModelRenderer upperbody1;
    AdvancedModelRenderer midbodybottom;
    AdvancedModelRenderer lowerbodybottom;
    AdvancedModelRenderer neckbottom;
    AdvancedModelRenderer upperjawmid2;
    AdvancedModelRenderer lowerjawmid2;
    AdvancedModelRenderer teeth_bottom;

    public ModelLiopleurodon() {
        textureWidth = 512;
        textureHeight = 256;

        midbody = new AdvancedModelRenderer(this, 115, 102);
        ...
        lowerjawback = new AdvancedModelRenderer(this, 15, 224);
        ...
        tailtip = new AdvancedModelRenderer(this, 60, 0);
        ...
        upperbody = new AdvancedModelRenderer(this, 2, 115);
        ...
        lowerjawmid = new AdvancedModelRenderer(this, 7, 189);
        ...
        upperjawback = new AdvancedModelRenderer(this, 168, 220);
        ...
        upperjawmid = new AdvancedModelRenderer(this, 152, 181);
        ...
        upperjawfront = new AdvancedModelRenderer(this, 103, 164);
        ...
        upperleftfin = new AdvancedModelRenderer(this, 189, 174);
        ...
        upperrightfin = new AdvancedModelRenderer(this, 189, 174);
        ...
        lowerleftfin = new AdvancedModelRenderer(this, 189, 174);
        ...
        lowerrightfin = new AdvancedModelRenderer(this, 189, 174);
        ...
        teeth_top = new AdvancedModelRenderer(this, 263, 175);
        ...
        lowerbodytop = new AdvancedModelRenderer(this, 3, 60);
        ...
        midbodytop = new AdvancedModelRenderer(this, 117, 102);
        ...
        upperbodytop = new AdvancedModelRenderer(this, 2, 115);
        ...
        upperbody1 = new AdvancedModelRenderer(this, 0, 115);
        ...
        midbodybottom = new AdvancedModelRenderer(this, 119, 102);
        ...
        lowerbodybottom = new AdvancedModelRenderer(this, 2, 59);
        ...
        neckbottom = new AdvancedModelRenderer(this, 132, 9);
        ...
        upperjawmid2 = new AdvancedModelRenderer(this, 152, 181);
        ...
        lowerjawmid2 = new AdvancedModelRenderer(this, 7, 189);
        ...
        teeth_bottom = new AdvancedModelRenderer(this, 263, 175);
    ...
    public void setRotation(AdvancedModelRenderer model, float x, float y, float z) {
